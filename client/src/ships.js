...
export const SHIPS = [
  ...
  { key: 'wisp',     nameKey: 'ship.wisp',     descKey: 'shipdesc.wisp',     tier: 'T1',       levelGate: 1,  price: 0,      currency: null,      displaySize: 96,  hullMax: 1000, shieldBase: 120, baseSpeed: 200, wSlots: 1, sSlots: 1, eSlots: 0, dmgMod: 1.00, garageKey: 'wisp_g', artAngleOffset: -Math.PI / 2 },
  ...
  { key: 'stiletto', nameKey: 'ship.stiletto', descKey: 'shipdesc.stiletto', tier: 'T2',       levelGate: 10, price: 80000,  currency: 'credits', displaySize: 92,  hullMax: 850,  shieldBase: 150, baseSpeed: 250, wSlots: 2, sSlots: 2, eSlots: 1, dmgMod: 1.05, artAngleOffset: -Math.PI / 2 },
  { key: 'anvil',    nameKey: 'ship.anvil',    descKey: 'shipdesc.anvil',    tier: 'T2',       levelGate: 15, price: 120000, currency: 'credits', displaySize: 105, hullMax: 1300, shieldBase: 210, baseSpeed: 205, wSlots: 3, sSlots: 3, eSlots: 1, dmgMod: 1.15, artAngleOffset: -Math.PI / 2 },
  { key: 'drover',   nameKey: 'ship.drover',   descKey: 'shipdesc.drover',   tier: 'T3',       levelGate: 25, price: 230000, currency: 'credits', displaySize: 113, hullMax: 1400, shieldBase: 230, baseSpeed: 205, wSlots: 5, sSlots: 5, eSlots: 2, dmgMod: 0.85, artAngleOffset: -Math.PI / 2 },
  { key: 'aegis',    nameKey: 'ship.aegis',    descKey: 'shipdesc.aegis',    tier: 'T3',       levelGate: 25, price: 260000, currency: 'credits', displaySize: 119, hullMax: 2500, shieldBase: 450, baseSpeed: 200, wSlots: 4, sSlots: 4, eSlots: 2, dmgMod: 0.90, artAngleOffset: -Math.PI / 2 },
  { key: 'phantom',  nameKey: 'ship.phantom',  descKey: 'shipdesc.phantom',  tier: 'T4',       levelGate: 40, price: 520000, currency: 'credits', displaySize: 113, hullMax: 1800, shieldBase: 400, baseSpeed: 235, wSlots: 6, sSlots: 6, eSlots: 2, dmgMod: 1.15, artAngleOffset: -Math.PI / 2 },

  // Prestige — за ⭐, гибрид-гейт. corp задаёт принадлежность (для текста требования).
  { key: 'helion', nameKey: 'ship.helion', descKey: 'shipdesc.helion', tier: 'T4 elite', levelGate: 45, price: 2500, currency: 'star', prestige: true, corp: 'helios', displaySize: 120, hullMax: 3500, shieldBase: 480, baseSpeed: 230, wSlots: 7, sSlots: 6, eSlots: 2, dmgMod: 1.15, artAngleOffset: -Math.PI / 2 },
  { key: 'argosy',   nameKey: 'ship.argosy',   descKey: 'shipdesc.argosy',   tier: 'T4 elite', levelGate: 45, price: 2500, currency: 'star', prestige: true, corp: 'karax',  displaySize: 119, hullMax: 3200, shieldBase: 440, baseSpeed: 215, wSlots: 7, sSlots: 6, eSlots: 2, dmgMod: 1.10, artAngleOffset: -Math.PI / 2 },
  { key: 'drifter',  nameKey: 'ship.drifter',  descKey: 'shipdesc.drifter',  tier: 'T4 elite', levelGate: 45, price: 2500, currency: 'star', prestige: true, corp: 'tides',  displaySize: 113, hullMax: 2800, shieldBase: 420, baseSpeed: 270, wSlots: 6, sSlots: 7, eSlots: 3, dmgMod: 1.15, artAngleOffset: -Math.PI / 2 },

  // Admin Ship
  { key: 'argus',    nameKey: 'ship.argus',    descKey: 'shipdesc.argus',    tier: 'ADMIN',    levelGate: 99, price: 0,      currency: null,      displaySize: 140, hullMax: 10000, shieldBase: 5000, baseSpeed: 450, wSlots: 10, sSlots: 10, eSlots: 10, dmgMod: 2.0, artAngleOffset: -Math.PI / 2 },
];
