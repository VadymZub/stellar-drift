...
export const MOBS = {
  ...
  syndicate_02: { key: 'syndicate_02', nameKey: 'mob.syndicate_02', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 114, hull: 260, shield: 170, damage: 8,  speed: 165, aggro: 650, range: 530, fireRate: 0.8,  credits: 320,  xp: 86,  patrolRadius: 240, leash: 640, starGold: { min: 6, max: 10, chance: 0.30 }, projectileType: 'ion',    aiClass: 'sniper' },
  ...
  syndicate_08: { key: 'syndicate_08', nameKey: 'mob.syndicate_08', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 132, hull: 560, shield: 320, damage: 13, speed: 145, aggro: 650, range: 530, fireRate: 0.65, credits: 720,  xp: 185, patrolRadius: 220, leash: 590, projectileType: 'ion',    aiClass: 'sniper' },
  ...
  guard_drone: { key: 'guard_drone', nameKey: 'mob.guard_drone', faction: 'guard', artAngleOffset: -Math.PI / 2, displaySize: 26,  hull: 200,  shield: 80,  damage: 8,  speed: 200, aggro: 650, range: 530, fireRate: 1.2, credits: 200,  xp: 50,  patrolRadius: 300, leash: 1500, neutral: true, projectileType: 'plasma', aiClass: 'gunner' },
...
// ×3 от DPR даёт больший запас оверсэмплинга над физическими пикселями — компенсирует
// image-rendering:pixelated на канвасе (нужен для чёткости спрайтов/моделей, см. index.html),
// который на нецелом DPR (Windows 125%/150%) огрубляет nearest-neighbor'ом ВСЁ содержимое
// канваса разом, включая текст — раздельно текст/спрайты не настроить, один канвас на
// оба (диалог: "можно чтобы и то и то было четким"). Больше запаса деталей на глаз
// частично компенсирует огрубление. Кап 6 — экономия видеопамяти на текстурах текста.
export const UI_RES = Math.min(6, Math.max(3, Math.ceil((window.devicePixelRatio || 1) * 3)));
