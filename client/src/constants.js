...
export const MOBS = {
  ...
  pirate_01: { key: 'pirate_01', nameKey: 'mob.pirate_01', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 88,  hull: 60,  shield: 0,   damage: 2,  speed: 205, aggro: 780, range: 340, fireRate: 1.0,  credits: 70,   xp: 22,  patrolRadius: 280, leash: 720, projectileType: 'plasma', aiClass: 'gunner' },
  pirate_02: { key: 'pirate_02', nameKey: 'mob.pirate_02', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 96,  hull: 90,  shield: 0,   damage: 3,  speed: 195, aggro: 820, range: 320, fireRate: 1.0,  credits: 95,   xp: 28,  patrolRadius: 320, leash: 780, projectileType: 'plasma', aiClass: 'gunner' },
  pirate_03: { key: 'pirate_03', nameKey: 'mob.pirate_03', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 100, hull: 120, shield: 30,  damage: 4,  speed: 195, aggro: 800, range: 380, fireRate: 0.85, credits: 120,  xp: 34,  patrolRadius: 260, leash: 680, projectileType: 'plasma', aiClass: 'gunner' },
  pirate_04: { key: 'pirate_04', nameKey: 'mob.pirate_04', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 98,  hull: 100, shield: 20,  damage: 5,  speed: 215, aggro: 820, range: 360, fireRate: 0.9,  credits: 130,  xp: 38,  patrolRadius: 300, leash: 760, projectileType: 'plasma', aiClass: 'gunner' },
  pirate_05: { key: 'pirate_05', nameKey: 'mob.pirate_05', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 112, hull: 160, shield: 40,  damage: 5,  speed: 165, aggro: 820, range: 400, fireRate: 0.75, credits: 160,  xp: 46,  patrolRadius: 240, leash: 640, projectileType: 'plasma', aiClass: 'dasher' },
  pirate_06: { key: 'pirate_06', nameKey: 'mob.pirate_06', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 116, hull: 200, shield: 50,  damage: 6,  speed: 155, aggro: 850, range: 420, fireRate: 0.7,  credits: 200,  xp: 55,  patrolRadius: 230, leash: 620, projectileType: 'plasma', aiClass: 'dasher' },
  pirate_07: { key: 'pirate_07', nameKey: 'mob.pirate_07', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 118, hull: 240, shield: 60,  damage: 7,  speed: 150, aggro: 850, range: 420, fireRate: 0.7,  credits: 240,  xp: 64,  patrolRadius: 220, leash: 600, projectileType: 'plasma', aiClass: 'dasher' },
  pirate_08: { key: 'pirate_08', nameKey: 'mob.pirate_08', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 128, hull: 320, shield: 90,  damage: 8,  speed: 140, aggro: 880, range: 440, fireRate: 0.65, credits: 320,  xp: 82,  patrolRadius: 210, leash: 560, elite: true, starGold: { min: 1, max: 3, chance: 0.05 }, projectileType: 'plasma', aiClass: 'berserker' },
  pirate_09: { key: 'pirate_09', nameKey: 'mob.pirate_09', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 150, hull: 700, shield: 250, damage: 9,  speed: 135, aggro: 950, range: 480, fireRate: 0.55, credits: 1500, xp: 380, patrolRadius: 200, leash: 460, boss: true, bossType: 'roaming', starGold: { min: 8, max: 20, chance: 1 }, projectileType: 'plasma' },
  ...
  syndicate_02: { key: 'syndicate_02', nameKey: 'mob.syndicate_02', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 114, hull: 260, shield: 170, damage: 8,  speed: 165, aggro: 860, range: 450, fireRate: 0.8,  credits: 320,  xp: 86,  patrolRadius: 240, leash: 640, projectileType: 'ion',    aiClass: 'gunner' },
  ...
  confed_01: { key: 'm01_striker',      nameKey: 'mob.confed_01', faction: 'confed', artAngleOffset: -Math.PI / 2, displaySize: 112, hull: 380,  shield: 210, damage: 10, speed: 175, aggro: 920,  range: 460, fireRate: 0.85, credits: 480,  xp: 125, patrolRadius: 240, leash: 680, projectileType: 'plasma', aiClass: 'dasher' },
  confed_02: { key: 'm02_scout',        nameKey: 'mob.confed_02', faction: 'confed', artAngleOffset: -Math.PI / 2, displaySize: 98,  hull: 240,  shield: 180, damage: 8,  speed: 215, aggro: 980,  range: 480, fireRate: 0.9,  credits: 420,  xp: 110, patrolRadius: 300, leash: 780, projectileType: 'plasma', aiClass: 'cloaker' },
  confed_06: { key: 'm06_interceptor',  nameKey: 'mob.confed_06', faction: 'confed', artAngleOffset: -Math.PI / 2, displaySize: 116, hull: 450,  shield: 320, damage: 11, speed: 195, aggro: 940,  range: 500, fireRate: 0.75, credits: 600,  xp: 150, patrolRadius: 220, leash: 620, elite: true, projectileType: 'plasma', aiClass: 'dasher' },
  ...
  sec_drone:     { key: 'aegis', nameKey: 'mob.sec_drone',     faction: 'security', artAngleOffset: Math.PI / 2, displaySize: 75,  hull: 220,  shield: 350, damage: 6,  speed: 205, aggro: 850,  range: 450, fireRate: 1.0, credits: 380,  xp: 95,   patrolRadius: 250, leash: 700, neutral: true, projectileType: 'ion',  aiClass: 'gunner' },
  sec_destroyer: { key: 'anvil', nameKey: 'mob.sec_destroyer', faction: 'security', artAngleOffset: Math.PI / 2, displaySize: 180, hull: 1400, shield: 750, damage: 17, speed: 135, aggro: 1100, range: 650, fireRate: 0.5, credits: 4500, xp: 1100, patrolRadius: 200, leash: 480, boss: true, bossType: 'static', neutral: true, starGold: { min: 15, max: 35, chance: 1 }, projectileType: 'grav' },
  ...
  apophis: { key: 'bigboss', sheetKey: 'bigboss', anim: 'bigboss_idle', frameW: 306, frameH: 419, nameKey: 'mob.apophis', faction: 'ancient', displaySize: 240, hull: 1800, shield: 1100, damage: 48, speed: 120, aggro: 1100, range: 600, fireRate: 0.5, credits: 5000, xp: 1200, patrolRadius: 240, leash: Infinity, boss: true, bossType: 'dungeon', starGold: { min: 20, max: 40, chance: 1 }, projectileType: 'acid' },

  // ── АРГУС (Admin-only) ──
  argus_boss: { key: 'argus', nameKey: 'mob.argus_boss', faction: 'admin', artAngleOffset: -Math.PI / 2, displaySize: 220, hull: 12000, shield: 8000, damage: 189, speed: 180, aggro: 1400, range: 620, fireRate: 1.5, credits: 0, xp: 0, patrolRadius: 300, leash: Infinity, boss: true, projectileType: 'plasma' },
};
