...
export const MOBS = {
  ...
  swarm_01: { key: 'swarm_01', nameKey: 'mob.swarm_01', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 88,  hull: 60,  shield: 0,   damage: 2,  speed: 205, aggro: 780, range: 340, fireRate: 1.0,  credits: 70,   xp: 22,  patrolRadius: 280, leash: 720, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  swarm_02: { key: 'swarm_02', nameKey: 'mob.swarm_02', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 96,  hull: 90,  shield: 0,   damage: 3,  speed: 195, aggro: 820, range: 320, fireRate: 1.0,  credits: 95,   xp: 28,  patrolRadius: 320, leash: 780, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  swarm_03: { key: 'swarm_03', nameKey: 'mob.swarm_03', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 100, hull: 120, shield: 30,  damage: 4,  speed: 195, aggro: 800, range: 380, fireRate: 0.85, credits: 120,  xp: 34,  patrolRadius: 260, leash: 680, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  swarm_04: { key: 'swarm_04', nameKey: 'mob.swarm_04', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 98,  hull: 100, shield: 20,  damage: 5,  speed: 215, aggro: 820, range: 360, fireRate: 0.9,  credits: 130,  xp: 38,  patrolRadius: 300, leash: 760, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  swarm_05: { key: 'swarm_05', nameKey: 'mob.swarm_05', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 112, hull: 160, shield: 40,  damage: 5,  speed: 165, aggro: 820, range: 400, fireRate: 0.75, credits: 160,  xp: 46,  patrolRadius: 240, leash: 640, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'dasher' },
  swarm_06: { key: 'swarm_06', nameKey: 'mob.swarm_06', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 116, hull: 200, shield: 50,  damage: 6,  speed: 155, aggro: 850, range: 420, fireRate: 0.7,  credits: 200,  xp: 55,  patrolRadius: 230, leash: 620, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'dasher' },
  swarm_07: { key: 'swarm_07', nameKey: 'mob.swarm_07', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 118, hull: 240, shield: 60,  damage: 7,  speed: 150, aggro: 850, range: 420, fireRate: 0.7,  credits: 240,  xp: 64,  patrolRadius: 220, leash: 600, starGold: { min: 1, max: 2, chance: 0.30 }, projectileType: 'plasma', aiClass: 'dasher' },
  swarm_08: { key: 'swarm_08', nameKey: 'mob.swarm_08', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 128, hull: 320, shield: 90,  damage: 8,  speed: 140, aggro: 880, range: 440, fireRate: 0.65, credits: 320,  xp: 82,  patrolRadius: 210, leash: 560, elite: true, starGold: { min: 2, max: 3, chance: 0.75 }, projectileType: 'plasma', aiClass: 'berserker' },
  swarm_09: { key: 'swarm_09', nameKey: 'mob.swarm_09', faction: 'swarm', artAngleOffset: -Math.PI / 2, displaySize: 150, hull: 700, shield: 250, damage: 9,  speed: 135, aggro: 950, range: 480, fireRate: 0.55, credits: 1500, xp: 380, patrolRadius: 200, leash: 460, boss: true, bossType: 'roaming', starGold: { min: 5, max: 7, chance: 1 }, projectileType: 'plasma' },

  // ── Корсары (люди-пираты) — ур. 8-30 ──
  corsair_01: { key: 'corsair_01', nameKey: 'mob.corsair_01', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 88,  hull: 90,  shield: 0,   damage: 4,  speed: 225, aggro: 800, range: 340, fireRate: 1.0,  credits: 85,   xp: 26,  patrolRadius: 280, leash: 720, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  corsair_02: { key: 'corsair_02', nameKey: 'mob.corsair_02', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 96,  hull: 120, shield: 20,  damage: 5,  speed: 235, aggro: 830, range: 360, fireRate: 0.95, credits: 115,  xp: 34,  patrolRadius: 300, leash: 760, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'dasher' },
  corsair_03: { key: 'corsair_03', nameKey: 'mob.corsair_03', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 110, hull: 170, shield: 30,  damage: 6,  speed: 190, aggro: 820, range: 400, fireRate: 0.85, credits: 150,  xp: 44,  patrolRadius: 260, leash: 680, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  corsair_04: { key: 'corsair_04', nameKey: 'mob.corsair_04', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 84,  hull: 85,  shield: 0,   damage: 4,  speed: 250, aggro: 840, range: 330, fireRate: 1.0,  credits: 95,   xp: 28,  patrolRadius: 320, leash: 800, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'dasher' },
  corsair_05: { key: 'corsair_05', nameKey: 'mob.corsair_05', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 118, hull: 220, shield: 50,  damage: 7,  speed: 175, aggro: 850, range: 410, fireRate: 0.8,  credits: 190,  xp: 56,  patrolRadius: 240, leash: 640, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  corsair_06: { key: 'corsair_06', nameKey: 'mob.corsair_06', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 108, hull: 170, shield: 90,  damage: 5,  speed: 200, aggro: 860, range: 420, fireRate: 0.8,  credits: 170,  xp: 50,  patrolRadius: 260, leash: 680, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'emp',    aiClass: 'shielder' },
  corsair_07: { key: 'corsair_07', nameKey: 'mob.corsair_07', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 130, hull: 340, shield: 80,  damage: 9,  speed: 155, aggro: 870, range: 430, fireRate: 0.72, credits: 310,  xp: 88,  patrolRadius: 230, leash: 620, starGold: { min: 2, max: 3, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  corsair_08: { key: 'corsair_08', nameKey: 'mob.corsair_08', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 140, hull: 400, shield: 110, damage: 10, speed: 162, aggro: 880, range: 450, fireRate: 0.68, credits: 390,  xp: 105, patrolRadius: 210, leash: 580, elite: true, starGold: { min: 3, max: 4, chance: 0.75 }, projectileType: 'plasma', aiClass: 'berserker' },
  corsair_09: { key: 'corsair_09', nameKey: 'mob.corsair_09', faction: 'corsair', artAngleOffset: -Math.PI / 2, displaySize: 158, hull: 950, shield: 320, damage: 11, speed: 142, aggro: 960, range: 490, fireRate: 0.55, credits: 1800, xp: 450, patrolRadius: 200, leash: 470, boss: true, bossType: 'roaming', starGold: { min: 7, max: 9, chance: 1 }, projectileType: 'plasma' },

  // ── Синдикат (организованная преступность) — ур. 15-45 ──
  syndicate_01: { key: 'syndicate_01', nameKey: 'mob.syndicate_01', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 108, hull: 200, shield: 130, damage: 7,  speed: 165, aggro: 860, range: 440, fireRate: 0.8,  credits: 260,  xp: 70,  patrolRadius: 250, leash: 660, starGold: { min: 6, max: 10, chance: 0.30 }, projectileType: 'plasma', aiClass: 'gunner' },
  syndicate_02: { key: 'syndicate_02', nameKey: 'mob.syndicate_02', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 114, hull: 260, shield: 170, damage: 8,  speed: 165, aggro: 860, range: 500, fireRate: 0.8,  credits: 320,  xp: 86,  patrolRadius: 240, leash: 640, starGold: { min: 6, max: 10, chance: 0.30 }, projectileType: 'ion',    aiClass: 'gunner' },
  syndicate_03: { key: 'syndicate_03', nameKey: 'mob.syndicate_03', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 120, hull: 330, shield: 210, damage: 9,  speed: 155, aggro: 880, range: 460, fireRate: 0.75, credits: 400,  xp: 105, patrolRadius: 230, leash: 620, starGold: { min: 6, max: 10, chance: 0.30 }, projectileType: 'ion',    aiClass: 'shielder' },
  syndicate_04: { key: 'syndicate_04', nameKey: 'mob.syndicate_04', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 110, hull: 240, shield: 150, damage: 8,  speed: 195, aggro: 880, range: 440, fireRate: 0.85, credits: 360,  xp: 96,  patrolRadius: 280, leash: 720, starGold: { min: 6, max: 10, chance: 0.30 }, projectileType: 'ion',    aiClass: 'shielder' },
  ...
  syndicate_11: { key: 'syndicate_11', nameKey: 'mob.syndicate_11', faction: 'syndicate', artAngleOffset: -Math.PI / 2, displaySize: 155, hull: 1600, shield: 900, damage: 16, speed: 140, aggro: 980, range: 520, fireRate: 0.5,  credits: 3000, xp: 700, patrolRadius: 200, leash: 480, boss: true, bossType: 'roaming', starGold: { min: 20, max: 30, chance: 1 }, projectileType: 'emp' },
  ...
  ancient_01: { key: 'ancient_01', nameKey: 'mob.ancient_01', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 130, hull: 500,  shield: 320, damage: 11, speed: 140, aggro: 950,  range: 500, fireRate: 0.65, credits: 700,  xp: 180, patrolRadius: 220, leash: 520, starGold: { min: 8, max: 15, chance: 0.30 }, projectileType: 'acid', aiClass: 'gunner' },
  ancient_02: { key: 'ancient_02', nameKey: 'mob.ancient_02', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 126, hull: 460,  shield: 380, damage: 12, speed: 150, aggro: 950,  range: 520, fireRate: 0.6,  credits: 760,  xp: 195, patrolRadius: 230, leash: 540, starGold: { min: 8, max: 15, chance: 0.30 }, projectileType: 'acid', aiClass: 'shielder' },
  ancient_03: { key: 'ancient_03', nameKey: 'mob.ancient_03', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 142, hull: 720,  shield: 420, damage: 13, speed: 128, aggro: 970,  range: 520, fireRate: 0.55, credits: 950,  xp: 240, patrolRadius: 210, leash: 500, elite: true, starGold: { min: 15, max: 25, chance: 0.75 }, projectileType: 'acid', aiClass: 'gunner' },
  ...
  ancient_05: { key: 'ancient_05', nameKey: 'mob.ancient_05', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 150, hull: 820,  shield: 520, damage: 14, speed: 125, aggro: 980,  range: 540, fireRate: 0.5,  credits: 1200, xp: 300, patrolRadius: 200, leash: 480, elite: true, starGold: { min: 15, max: 25, chance: 0.75 }, projectileType: 'acid', aiClass: 'berserker', minelayer: true, mineInterval: 6 },
  ...
  ancient_07:   { key: 'ancient_07',   nameKey: 'mob.ancient_07',   faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 100, hull: 300, shield: 100, damage: 8,  speed: 80,  aggro: 600, range: 350, fireRate: 0.9,  credits: 600,  xp: 150, patrolRadius: 150, leash: 400, starGold: { min: 8, max: 15, chance: 0.30 }, projectileType: 'grav', aiClass: 'gunner' },
  ancient_07_1: { key: 'ancient_07_1', nameKey: 'mob.ancient_07_1', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 100, hull: 240, shield: 80,  damage: 6,  speed: 95,  aggro: 650, range: 380, fireRate: 1.1,  credits: 550,  xp: 140, patrolRadius: 150, leash: 400, starGold: { min: 8, max: 15, chance: 0.30 }, projectileType: 'grav', aiClass: 'gunner' },
  ...
  ancient_08: { key: 'ancient_08', nameKey: 'mob.ancient_08', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 122, hull: 420, shield: 320, damage: 9,  speed: 145, aggro: 960, range: 530, fireRate: 0.65, credits: 800,  xp: 200, patrolRadius: 230, leash: 540, starGold: { min: 8, max: 15, chance: 0.30 }, projectileType: 'void',   aiClass: 'shielder' },
  ancient_09: { key: 'ancient_09', nameKey: 'mob.ancient_09', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 148, hull: 850, shield: 480, damage: 16, speed: 122, aggro: 980, range: 540, fireRate: 0.55, credits: 1050, xp: 265, patrolRadius: 210, leash: 510, starGold: { min: 10, max: 18, chance: 0.30 }, projectileType: 'acid',   aiClass: 'gunner' },
  ancient_10: { key: 'ancient_10', nameKey: 'mob.ancient_10', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 172, hull: 1200, shield: 650, damage: 18, speed: 110, aggro: 990, range: 560, fireRate: 0.5,  credits: 1400, xp: 350, patrolRadius: 200, leash: 490, elite: true, starGold: { min: 18, max: 30, chance: 0.75 }, projectileType: 'acid',   aiClass: 'gunner' },
  ...
  ancient_13: { key: 'ancient_13drone', nameKey: 'mob.ancient_13', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 88, hull: 260, shield: 80, damage: 10, speed: 90, aggro: 700, range: 320, fireRate: 0.22, credits: 260, xp: 170, patrolRadius: 380, leash: 900, projectileType: 'acid', bossHealer: true, healRange: 650, healRate: 2500 },
  // Хранитель Коридора — уникальный мини-босс в конце каждого коридора R-1-boss
  ancient_miniboss: { key: 'ancient_miniboss', nameKey: 'mob.ancient_miniboss', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 160, hull: 900, shield: 500, damage: 32, speed: 115, aggro: 1050, range: 580, fireRate: 0.42, credits: 1800, xp: 500, patrolRadius: 320, leash: 1300, elite: true, starGold: { min: 12, max: 22, chance: 0.9 }, projectileType: 'void', aiClass: 'gunner' },
  // Орбитальный дрон-блокировщик: поглощает 90% урона по боссу пока жив; спавн группами по 3
  ancient_shield: { key: 'ancient_shield', nameKey: 'mob.ancient_shield', faction: 'ancient', artAngleOffset: -Math.PI / 2, displaySize: 92, hull: 420, shield: 280, damage: 12, speed: 135, aggro: 750, range: 400, fireRate: 0.45, credits: 320, xp: 200, patrolRadius: 300, leash: 800, projectileType: 'void', aiClass: 'shielder', shieldDrone: true },
