...
## ammo_plasma.png — Плазма-патроны
...
## ammo_laser.png — Лазерные заряды

**Цвет:** фиолетовый #7c4dff · Заряды для лазерной пушки

```
Square game inventory icon, dark navy background,
laser energy cell / power pack, crystalline purple (#7c4dff) energy
matrix visible through transparent casing, geometric lattice structure
